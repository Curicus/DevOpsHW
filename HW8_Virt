...
Смысл в том что клиент может удаленно находится с танким клиентом и монитором, подключаться к терминалу и работать с каким то отдельным приложением, к которому ему предоставлен доступ.
К данной виртуализации можно отнести очень популярную технологию VDI.
Это очень удобно, так как информация консолидирована на серверных мощностях, скорость организации и предоставления доступа к сервису.
Руководству не надо покупать мощные ПЭВМ для работников, достаточно тонких клиентов, экономия на потреблении электронергии.
Танким местом здесь может быть сетевая инфраструктура, при плохом доступе с рабочего места до серверных мощностей будут пробелмы.

2. **Виртуализация приложений**
Такая виртуализация это отделение приложения от ОС. Тоесть рабочая машина может не обладать хорошей графикой, но ей надо работать с тяжеловесным графическим приложением. 
Такое приложение можно виртуализировать на серверных можностях с интегрированными графическими ускорителями и презентовать работнику для работы на рабочем месте. 
...
и использовать уже его как виртуальное приложение, которое не будет использоваться какие то системные библиотеки общего назначения.
К недостаткам можно отнести опять же нагрузку на сеть, деградация производительности при перегружки серверных можностей, ну и высокая стоимость внедрения, необходимо учитывать множество лицензий.

3. **Виртуализация оборудования**
...
Ну и опять же лицензирование всей виртуальнйо инфраструктур может вести к серьезным финансовым затратам.

```
### Что такое гипервизор?
Это миниатюрная ОС, которая является прослойкой можно аппаратно частью сервера и виртуальными мошинами. 
Собственно в ее задачи входит процесс эмуляции физических мощностей и передачу их к виртуальным машинам.
Он занимается всем расчетами ресурсов для распределениях их между виртуалками, обеспечивая надежность и достаточность для правильной работы.
